/**
 * Validate a Shield candidate GLB against the ALLY asset contract.
 *
...
//
// Wiring a "shield" key into the manifest is a RUNTIME change and this is the
// art pipeline, so the mismatch is recorded as a known limitation for the
...
const glbPath = process.argv[2]
  ?? resolve(process.cwd(), "public/assets/models/characters/shield_candidate.glb");
