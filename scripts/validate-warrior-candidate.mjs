/**
 * Validate a Warrior candidate GLB against the ALLY asset contract.
 *
...
const glbPath = process.argv[2]
  ?? resolve(process.cwd(), "public/assets/models/characters/warrior_candidate.glb");
...
function contractFromManifest() {
  ...
  if (!nodes || !anims) throw new Error("could not read the warrior contract from AssetManifest.ts");
