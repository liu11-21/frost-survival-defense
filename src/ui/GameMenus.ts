    ...
    this.render(`
      ...
      <div class="menu-cols help">
        ...
        <div class="menu-col">
          ...
          <h2>火爐升級</h2>
          <p class="muted">靠近中央火爐按 E，可以看到升級前後的實際數值，最高 Lv.100。每級會同步提升所有我方兵種生命／攻擊／攻速，以及可受擊設施生命／攻擊；火爐與可受擊設施未受擊 15 秒後，依火爐等級每秒回復 1%～10% 最大生命；Lv.11 另有 8 秒一次性 10% 修復，之後每級固定增加 5,000 HP。無限模式升級還會增加小隊上限。</p>
          <h2>開發者工具</h2>
