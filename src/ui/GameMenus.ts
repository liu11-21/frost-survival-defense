    ...
    this.render(`
      ...
      <div class="menu-cols help">
        <div class="menu-col">
          ...
          <h2>主角技能</h2>
          <p class="muted">Q 冰霜震擊：以自身為中心震擊周圍敵人並使其減速。<br>R 火力齊射：對目前鎖定的敵人連射數箭。<br>F 緊急集結：治療自身與周圍友軍並賦予短暫傷害減免。<br>三者皆只有冷卻時間，不消耗任何資源。</p>
        </div>
        <div class="menu-col">
          <h2>建造</h2>
          <p class="muted">靠近固定槽位按 E 打開建造選單，選擇建築並確認成本。<br>自動重建站只會重建「本局曾經完成過」的設施，並依摧毀先後順序處理。</p>
          <h2>招募</h2>
          <p class="muted">先建造招募所，按 G 隨時打開招募選單（不需要靠近）。<br>招募會消耗金幣與小隊容量，金幣只能由擊殺敵人取得。</p>
          <h2>拆除</h2>
          <p class="muted">靠近任何非核心設施按 E 開啟設施資訊面板，面板內有「拆除設施」。<br>返還 50% 木材與石頭，金幣不返還，二次確認後才會真正拆除。</p>
          <h2>火爐升級</h2>
          <p class="muted">靠近中央火爐按 E，可以看到升級前後的實際數值。<br>無限模式的火爐升級還會增加小隊上限。</p>
          <h2>開發者工具</h2>
