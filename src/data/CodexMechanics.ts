...
export const MECHANIC_ENTRIES: CodexEntry[] = [
  ...
  mechanic("expansion-and-air", "火爐擴張與空軍", [
    ["地面點位", "Lv.1～10 由核心向外逐圈解鎖，數量為 4／7／10／13／16／19／22／25／28／31；未解鎖點位不參與建造與碰撞"],
    ["天空點位", "Lv.15／20／25／30／35 各解鎖一座，最多五座；只能建造攻擊型設施，成本 ×1.25、傷害 ×1.5，且不會成為現有敵人的目標"],
    ["空中敵人", "飛行單位可越過城牆；近戰、盾兵、工程兵、掌旗者不能鎖定，遠程兵種、主角與攻擊設施可以鎖定"],
    ["天空專屬", "弩箭塔三連射、砲塔連擊、冰霜塔三次命中凍結、狙擊塔破甲與爆擊、火焰迫擊砲燃燒"],
  ], "先用遠程火力處理飛行敵人，再利用天空平台的高度與專屬效果建立交叉火力。"),
