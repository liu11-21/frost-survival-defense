...
export const UNIT_VISUALS: Record<string, UnitVisual> = {
  ...
  flyingMelee: {
    ...
    limb: [0.22, 0.18, 0.3],
    head: [0.58, 0.58, 0.72],
    crest: [0.64, 0.45, 0.92],
    weapon: "club",
    accent: [0.45, 0.85, 1.0],
    attachments: [
      { shape: "box", parent: "shoulderL", position: [0, 0.08, 0], rotation: [0, 0, -0.35], size: [0.65, 0.08, 0.3], material: "accent" },
      { shape: "box", parent: "shoulderR", position: [0, 0.08, 0], rotation: [0, 0, 0.35], size: [0.65, 0.08, 0.3], material: "accent" },
    ],
  },
  flyingEliteArcher: {
    body: [0.28, 0.4, 0.58],
    ...
    crest: [0.42, 0.7, 0.95],
    weapon: "bow",
    accent: [0.35, 0.95, 1.0],
    attachments: [
      { shape: "box", parent: "back", position: [-0.4, 0.8, 0], rotation: [0, 0, -0.18], size: [0.72, 0.07, 0.34], material: "accent" },
      { shape: "box", parent: "back", position: [0.4, 0.8, 0], rotation: [0, 0, 0.18], size: [0.72, 0.07, 0.34], material: "accent" },
    ],
  },
  flyingBomber: {
    ...
    limb: [0.24, 0.16, 0.32],
    head: [0.5, 0.5, 0.64],
    crest: [0.82, 0.38, 0.92],
    weapon: "staff",
    accent: [1.0, 0.45, 0.9],
    cape: true,
    attachments: [
      { shape: "sphere", parent: "body", position: [0, 0.85, 0.15], size: [0.3, 0.3, 0.3], material: "accent" },
      { shape: "box", parent: "shoulderL", position: [0, 0.12, 0], rotation: [0, 0, -0.45], size: [0.9, 0.08, 0.35], material: "accent" },
      { shape: "box", parent: "shoulderR", position: [0, 0.12, 0], rotation: [0, 0, 0.45], size: [0.9, 0.08, 0.35], material: "accent" },
    ],
  },
  flyingColossus: {
    body: [0.18, 0.2, 0.36],
    ...
    cape: true,
    torsoSize: [0.62, 0.76, 0.42],
    attachments: [
      { shape: "box", parent: "back", position: [-0.52, 1.05, 0], rotation: [0, 0, -0.2], size: [1.1, 0.12, 0.52], material: "accent" },
      { shape: "box", parent: "back", position: [0.52, 1.05, 0], rotation: [0, 0, 0.2], size: [1.1, 0.12, 0.52], material: "accent" },
    ],
  },
};
