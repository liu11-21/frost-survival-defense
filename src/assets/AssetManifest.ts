...
export const AUTHORED_ASSET_MANIFEST: readonly AssetSpec[] = [
  ...
  ...ECONOMY_ASSETS.map((key): AssetSpec => ({
    ...
    rootUrl: "/assets/models/buildings/",
    fileName: `${key}.glb`,
    requiredNodes: ["BuildingRoot", "productionCore", "workPart"],
  ...
  ...ATTACK_ASSETS.map((key): AssetSpec => ({
    ...
    rootUrl: "/assets/models/buildings/",
    fileName: `${key}.glb`,
    requiredNodes: ["BuildingRoot", "yawPivot", "pitchPivot", "barrel", "muzzle", "recoilPart"],
  ...
  })),
  {
    ...
    requiredNodes: ["FurnaceRoot", "heatCore", "furnaceCrown", "emitter"],
    requiredAnimations: ["Idle", "Operate", "Damaged", "Destroyed"],
    fallback: "procedural",
  },
];
